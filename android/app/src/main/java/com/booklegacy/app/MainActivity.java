...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " BookLegacyAndroidApp/3.26");
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                view.evaluateJavascript("window.__BOOKLEGACY_ANDROID_APP=true;window.__BOOKLEGACY_ANDROID_VERSION='3.26';" +
    ...
    private String buildFreshUrl() {
        ...
        builder.appendQueryParameter("v", "326");
